Decimo archivo, los mixin en dart, este es el codigo 
...
```
En el presente codigo vemos como se usa el mixin para compartir compartimientos entre clases sin requerir multiples herencias 
